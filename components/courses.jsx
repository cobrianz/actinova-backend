...
import { Plus, Edit, Eye, Trash2, Users, BarChart3, Save, X, Star } from "lucide-react"
...
const mockCourses = [
  {
    ...
    skills: ["Component Development", "State Management", "Props"],
    roadmapSteps: [
  ...
  },
  {
    id: 2,
    title: "Python for AI",
    description: "Master Python programming for artificial intelligence",
    status: "Draft",
    completionRate: 0,
    enrolledUsers: 0,
    level: "Intermediate",
    tags: ["Python", "AI", "Machine Learning"],
    skills: ["Python Basics", "NumPy", "Pandas", "Scikit-learn"],
    roadmapSteps: ["Python Basics", "Data Structures", "NumPy and Pandas", "Machine Learning Basics", "AI Project"],
    price: 149,
    duration: "12 weeks",
    rating: 0,
...
export default function EnhancedCoursesInline() {
  ...
  const handleSave = () => {
    ...
    if (isCreating) {
      ...
      setCourses(courses.map((course) => (course.id === selectedCourse.id ? { ...course, ...courseData } : course)))
      setFilteredCourses(
        filteredCourses.map((course) => (course.id === selectedCourse.id ? { ...course, ...courseData } : course)),
      )
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-4">
            <select className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
